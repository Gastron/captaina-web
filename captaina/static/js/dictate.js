(function(window){
	...
	// Defaults
	var SERVER = "ws://localhost:8888/client/ws/speech";
	var SERVER_STATUS = "ws://localhost:8888/client/ws/status";
	var REFERENCE_HANDLER = "http://localhost:8888/client/dynamic/reference";
	...
	var Dictate = function(cfg) {
      ...
      //if (config["graph_id"]) {
      //  headers['Graph-Id'] = config["graph_id"]
      //}
			$.ajax({
